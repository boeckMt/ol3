...
goog.require('ol.xml');
goog.require('ol.format.WMSCapabilitiesBase');


/**
 * @classdesc
 * Format for reading WMS capabilities data version 1.1.1
 *
 * @constructor
...
ol.format.WMSCapabilities1_1_1.readAttribution_ = function(node, objectStack) {
  ...
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_1_1.ATTRIBUTION_PARSERS_, node, objectStack);
};
 ...
 * @see http://schemas.opengis.net/wms/1.1.1/capabilities_1_1_1.dtd
 */
ol.format.WMSCapabilities1_1_1.readDimensionExtent_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
    'node.nodeType should be ELEMENT');
...
ol.format.WMSCapabilities1_1_1.LAYER_PARSERS_ = ol.xml.makeStructureNS(
  ol.format.WMSCapabilities1_1_1.NAMESPACE_URIS_, {
    ...
    'EX_GeographicBoundingBox': ol.xml.makeObjectPropertySetter(
      ol.format.WMSCapabilities1_1_1.readEXGeographicBoundingBox_),
    ...
    'Extent': ol.xml.makeObjectPropertyPusher(
      ol.format.WMSCapabilities1_1_1.readDimensionExtent_),
