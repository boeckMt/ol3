goog.provide('ol.format.WMSCapabilities1_3_0');
 ...
 * @api
 */
ol.format.WMSCapabilities1_3_0 = function() {
...
goog.inherits(ol.format.WMSCapabilities1_3_0, ol.format.XML);
 ...
 * @api
 */
ol.format.WMSCapabilities1_3_0.prototype.read;
 ...
 */
ol.format.WMSCapabilities1_3_0.prototype.readFromDocument = function(doc) {
 ...
 * @return {Object} WMS Capability object.
 */
ol.format.WMSCapabilities1_3_0.prototype.readFromNode = function(node) {
  ...
  }, ol.format.WMSCapabilities1_3_0.PARSERS_, node, []);
 ...
 */
ol.format.WMSCapabilities1_3_0.readAttribution_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Attribution',
      'localName should be Attribution');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.ATTRIBUTION_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readBoundingBox_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
 ...
 */
ol.format.WMSCapabilities1_3_0.readEXGeographicBoundingBox_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  ...
  var geographicBoundingBox = ol.xml.pushParseAndPop(
      {},
      ol.format.WMSCapabilities1_3_0.EX_GEOGRAPHIC_BOUNDING_BOX_PARSERS_,
      node, objectStack);
 ...
 */
ol.format.WMSCapabilities1_3_0.readCapability_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Capability',
      'localName should be Capability');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.CAPABILITY_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readService_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Service',
      'localName should be Service');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.SERVICE_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readContactInformation_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
  ...
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.CONTACT_INFORMATION_PARSERS_,
      node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readContactPersonPrimary_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'ContactPersonPrimary',
      'localName should be ContactPersonPrimary');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.CONTACT_PERSON_PARSERS_,
      node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readContactAddress_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'ContactAddress',
      'localName should be ContactAddress');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.CONTACT_ADDRESS_PARSERS_,
      node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readException_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Exception',
      'localName should be Exception');
  return ol.xml.pushParseAndPop(
      [], ol.format.WMSCapabilities1_3_0.EXCEPTION_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readCapabilityLayer_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Layer', 'localName should be Layer');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.LAYER_PARSERS_, node, objectStack);
};
 ...
 * @return {Object|undefined} Layer object.
 */
ol.format.WMSCapabilities1_3_0.readLayer_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Layer', 'localName should be Layer');
 ...
 */
ol.format.WMSCapabilities1_3_0.readDimension_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
 ...
 */
ol.format.WMSCapabilities1_3_0.readFormatOnlineresource_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.FORMAT_ONLINERESOURCE_PARSERS_,
      node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readRequest_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Request',
      'localName should be Request');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.REQUEST_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readDCPType_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'DCPType',
      'localName should be DCPType');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.DCPTYPE_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readHTTP_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'HTTP', 'localName should be HTTP');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.HTTP_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readOperationType_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.OPERATIONTYPE_PARSERS_, node, objectStack);
};
 ...
 * @return {Object|undefined} Online resource object.
 */
ol.format.WMSCapabilities1_3_0.readSizedFormatOnlineresource_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  var formatOnlineresource =
      ol.format.WMSCapabilities1_3_0.readFormatOnlineresource_(node, objectStack);
 ...
 */
ol.format.WMSCapabilities1_3_0.readAuthorityURL_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
 ...
 */
ol.format.WMSCapabilities1_3_0.readMetadataURL_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
 ...
 */
ol.format.WMSCapabilities1_3_0.readStyle_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'Style', 'localName should be Style');
  return ol.xml.pushParseAndPop(
      {}, ol.format.WMSCapabilities1_3_0.STYLE_PARSERS_, node, objectStack);
};
 ...
 */
ol.format.WMSCapabilities1_3_0.readKeywordList_ = function(node, objectStack) {
  goog.asserts.assert(node.nodeType == goog.dom.NodeType.ELEMENT,
      'node.nodeType should be ELEMENT');
  goog.asserts.assert(node.localName == 'KeywordList',
      'localName should be KeywordList');
  return ol.xml.pushParseAndPop(
      [], ol.format.WMSCapabilities1_3_0.KEYWORDLIST_PARSERS_, node, objectStack);
};
 ...
 * @type {Array.<string>}
 */
ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_ = [
  null,
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'Service': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readService_),
      'Capability': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readCapability_)
    });
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.CAPABILITY_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'Request': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readRequest_),
      'Exception': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readException_),
      'Layer': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readCapabilityLayer_)
    });
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.SERVICE_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.CONTACT_INFORMATION_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'ContactPersonPrimary': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readContactPersonPrimary_),
      'ContactPosition': ol.xml.makeObjectPropertySetter(
          ol.format.XSD.readString),
      'ContactAddress': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readContactAddress_),
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.CONTACT_PERSON_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.CONTACT_ADDRESS_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.EXCEPTION_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.LAYER_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'Name': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
      'Title': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
      'Abstract': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
      ...
      'EX_GeographicBoundingBox': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readEXGeographicBoundingBox_),
      'BoundingBox': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readBoundingBox_),
      'Dimension': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readDimension_),
      'Attribution': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readAttribution_),
      'AuthorityURL': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readAuthorityURL_),
      'Identifier': ol.xml.makeObjectPropertyPusher(ol.format.XSD.readString),
      'MetadataURL': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readMetadataURL_),
      'DataURL': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readFormatOnlineresource_),
      'FeatureListURL': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readFormatOnlineresource_),
      'Style': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readStyle_),
      ...
      'Layer': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readLayer_)
    });
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.ATTRIBUTION_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'Title': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
      'OnlineResource': ol.xml.makeObjectPropertySetter(
          ol.format.XLink.readHref),
      'LogoURL': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readSizedFormatOnlineresource_)
    });
 ...
 */
ol.format.WMSCapabilities1_3_0.EX_GEOGRAPHIC_BOUNDING_BOX_PARSERS_ =
    ol.xml.makeStructureNS(ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.REQUEST_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'GetCapabilities': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readOperationType_),
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.OPERATIONTYPE_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'Format': ol.xml.makeObjectPropertyPusher(ol.format.XSD.readString),
      'DCPType': ol.xml.makeObjectPropertyPusher(
          ol.format.WMSCapabilities1_3_0.readDCPType_)
    });
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.DCPTYPE_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'HTTP': ol.xml.makeObjectPropertySetter(
          ol.format.WMSCapabilities1_3_0.readHTTP_)
    });
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.HTTP_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.STYLE_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
      'Name': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
      'Title': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
      'Abstract': ol.xml.makeObjectPropertySetter(ol.format.XSD.readString),
 ...
 * @private
 */
ol.format.WMSCapabilities1_3_0.KEYWORDLIST_PARSERS_ = ol.xml.makeStructureNS(
    ol.format.WMSCapabilities1_3_0.NAMESPACE_URIS_, {
