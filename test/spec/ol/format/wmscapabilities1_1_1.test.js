goog.provide('ol.test.format.WMSCapabilities1_1_1');

describe('ol.format.WMSCapabilities1_1_1', function() {

  describe('when parsing ogcsample.xml', function() {

    var parser = new ol.format.WMSCapabilities1_1_1();
    var capabilities;
    before(function(done) {
      afterLoadText('spec/ol/format/wms/getcapabilities_1.1.1.xml', function(xml) {
        try {
    ...
    it('can read Capability.Exception', function() {
      ...
      expect(exception).to.eql(['application/vnd.ogc.se_xml', 'application/vnd.ogc.se_inimage', 'application/vnd.ogc.se_blank']);
    });
    ...
    it('can read Capability.Request.DescribeLayer', function() {
      var describeLayer = capabilities.Capability.Request.DescribeLayer;
    ...
    it('can read Capability.Layer', function() {
      ...
      expect(layer.BoundingBox).to.be(undefined);
